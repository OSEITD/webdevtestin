...
<head>
    ...
    <!-- PWA Manifest -->
    <link rel="manifest" href="<?php echo $adminBaseUrl; ?>/manifest.json?v=3">
    <meta name="apple-mobile-web-app-title" content="Nex-er Admin" />
    <meta name="theme-color" content="#2e0b3f">
    <link rel="apple-touch-icon" href="/shared/apple-touch-icon-180x180.png">
