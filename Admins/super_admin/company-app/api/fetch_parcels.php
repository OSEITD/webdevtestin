...
class DeliveriesAPI {
    ...
    private function getFilters() {
        return [
            ...
            'origin_outlet_id' => $_GET['origin'] ?? ($_GET['outlet_id'] ?? null),
            'destination_outlet_ids' => isset($_GET['destinations']) ? explode(',', $_GET['destinations']) : null,
            // When fetching for trip assignment (when origin is passed), exclude assigned/completed/in-transit parcels
            'exclude_statuses' => isset($_GET['origin']) ? ['assigned', 'delivered', 'completed', 'in-transit', 'in_transit', 'in progress', 'dispatched'] : null
        ];
    }
