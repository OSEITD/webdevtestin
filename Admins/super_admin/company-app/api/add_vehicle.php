...
// Validate status against canonical DB values
$canonicalStatuses = ['available', 'assigned', 'out_for_delivery', 'unavailable'];
...
try {
    ...
    if (!empty($existingVehicles)) {
        ...
        echo json_encode([
            ...
            'errors' => ['plate_number' => 'A vehicle with this plate number already exists in your company.']
        ]);
        exit;
    }
