...
try {
    ...
    $driversPath = "drivers?driver_name=ilike.%25{$escaped}%25&deleted_at=is.null&select=id,driver_name,driver_phone,status&limit=6";
    try {
    ...
    $outletsPath = "outlets?outlet_name=ilike.%25{$escaped}%25&deleted_at=is.null&select=id,outlet_name,address,status&limit=6";
    try {
