...
?>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td data-label="Status">
                                <?php
                                    $outletStatus = strtolower($outlet['status'] ?? 'inactive');
                                    $outletStatusClass = 'status-inactive';
                                    if ($outletStatus === 'active') $outletStatusClass = 'status-active';
                                    elseif ($outletStatus === 'maintenance') $outletStatusClass = 'status-maintenance';
                                ?>
                                <span class="status-badge <?php echo $outletStatusClass; ?>">
                                    <?php echo ucfirst(htmlspecialchars($outletStatus)); ?>
                                </span>
                            </td>
                            <td data-label="Actions">
                                <a href="view-outlet.php?id=<?php echo htmlspecialchars($outlet['id']); ?>" class="action-btn view-btn">View</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
    ...
    <script>
        ...
        // Auto-refresh page every 30 seconds to check for new outlets
