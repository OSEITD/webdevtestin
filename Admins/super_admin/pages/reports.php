...
?>
            ...
            <div class="report-card">
                ...
                <div class="report-stats">
                    <div class="stat-item">
                        ...
                        <span class="stat-value" data-stat="revenue-total"><?php echo formatCurrency($revenueStats['total_revenue'], $globalCurrency); ?></span>
                    </div>
                    <div class="stat-item">
    ...
    <script>
        // Currency info from server (same approach as dashboard)
        const reportCurrency = <?php
            $symbols = [
                'USD' => '$', 'EUR' => '€', 'GBP' => '£', 'JPY' => '¥',
            ...
            $sym = $symbols[$globalCurrency] ?? $globalCurrency;
            echo json_encode(['code' => $globalCurrency, 'symbol' => $sym]);
        ?>;
                    ...
                    try {
                        switch(format) {
                            case 'number':
                                ...
                                break;
                            case 'currency':
                                element.textContent = `${reportCurrency.symbol}${Number(value || 0).toLocaleString('en-US', { 
