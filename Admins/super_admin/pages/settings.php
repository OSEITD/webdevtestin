...
?>
                                ...
                                <div class="info-group">
                                    ...
                                    <div class="dropdown" id="defaultCurrencyDropdown">
                                        <button type="button" class="dropdown-toggle">
                                            <span id="selectedDefaultCurrency"><?php echo htmlspecialchars($currentSettings['global_currency'] ?? 'ZMW - Zambian Kwacha'); ?></span>
                                    ...
                                    <input type="hidden" name="defaultCurrency" id="defaultCurrencyInput" 
                                           value="<?php echo htmlspecialchars($currentSettings['global_currency'] ?? 'ZMW - Zambian Kwacha'); ?>">
                                </div>
                                <div class="info-group">
    ...
    <script>
        ...
        function populateForm(settings) {
            ...
            document.getElementById('selectedDefaultCurrency').textContent = settings.global_currency || 'ZMW - Zambian Kwacha';
            document.getElementById('defaultCurrencyInput').value = settings.global_currency || 'ZMW - Zambian Kwacha';
